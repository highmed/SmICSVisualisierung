...
class Tooltip extends React.Component {
  ...
  hideTooltip() {
    ...
    // this.tooltip
    d3.select(this.tooltipDiv).style("display", "none")
  }
  ...
  showTooltip() {
    ...
    // console.log(this.id)
    // this.tooltip
    d3.select(this.tooltipDiv).style("display", "inline-block")
  }
              ...
              element.content.forEach((e) => {
                ...
                if (e && Array.isArray(e)) {
                  ...
                  if (e.length === 0) {
                    ...
                    e.forEach((e2) => {
                      tdArray.push(
                        <td key={self.id + self.key}>{String(e2)}</td>
                      )
                      self.key = self.key + 1
                    })
                  }
