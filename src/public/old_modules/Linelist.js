...
class LineList extends Component {
  constructor(props) {
    ...
    // this.getDataFuncName = this.props.getDataFuncNames[0]
  ...
  componentWillMount() {
    ...
    this.socket.on("dataResult", this.handleData)
  ...
  getData = () => {
    ...
    self.socket.emit("getData", {
      dataSourceIdentifier: "hmhdnov18_sql",
      procedureName: "Patient_Bewegung_Ps",
      procedureParameters: {
        patientList: ["123", "456"],
      },
    })
    ...
    //   parameters: {
    //     mint: filterValues.mint,
    //     maxt: filterValues.maxt,
    //     keimID: filterValues.keimID,
    //     patientID: filterValues.patientID,
    //     grad: filterValues.grad,
    //     hospitalID: filterValues.hospitalID,
    //     lop: filterValues.lop,
    //   },
    //   database: filterValues.database,
    //   moduleName: this.id,
    //   // procedure: this.getDataFuncName,
    //   procedure: this.props.getDataFuncNames[this.state.contact_depth],
    // })
    // }
  }
...
// export default hot(module)(LineList)
